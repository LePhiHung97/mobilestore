			...
			<div class="col-sm-8 col-md-8">
				<div class="row">
					...
					<div class="col-sm-5 col-md-5">
						<img id="hinhsanpham" data-value="${sanpham.hinhsanpham }"
							src="<c:url value="/resources/images/product/${sanpham.hinhsanpham}" />"
							alt="" height="300px">
					</div>

					<div class="col-sm-7 col-md-7">
						<h4 id="tensp" data-value="${sanpham.masanpham}"
							style="margin-top: -1px">
							<strong>${sanpham.tensanpham}</strong>
						</h4>
						<h4 id="giatien" data-value="${sanpham.giatien}"
							style="color: red">${sanpham.giatien}<span>&nbspVND</span>
						</h4>
							...
							<tbody>
								<c:forEach var="chitietsanpham"
									...
									<tr>
										...
										<td><button
												data-chitietsanpham="${chitietsanpham.machitietsanpham}"
												type="button" class="btn btn-success btn-giohang">Thêm
												vào giỏ</button></td>
									</tr>
								</c:forEach>
							</tbody>
